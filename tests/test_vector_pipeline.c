...
int main(void)
{
    ...
    memcpy(rule.fingerprint, "PATCH123", 8U);
    rule.fingerprint_size = 8U;
    ...
    CHECK(results[2].adjusted_score == 45);
    ...
    printf("PASS: safe vector provenance/fingerprint pipeline\n");
    return 0;
}
